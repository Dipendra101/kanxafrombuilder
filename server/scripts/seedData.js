...
const SERVICES = [
  // Bus Services
  {
    ...
    description: 'Premium bus service from Lamjung to Kathmandu with AC and entertainment',
    type: 'bus',
    ...
    busService: {
      ...
      vehicle: {
        busType: 'Deluxe AC',
        totalSeats: 45,
        amenities: ['AC', 'WiFi', 'Entertainment', 'Charging Port', 'Reclining Seats']
      }
    },
    rating: {
      average: 4.5,
  ...
  // Cargo Services
  {
    ...
    cargoService: {
      ...
      features: ['GPS Tracking', 'Insurance Covered', '24/7 Support', 'Loading/Unloading']
    },
    rating: {
      average: 4.7,
      count: 45
  ...
  // Tour Services
  {
    ...
    description: 'Professional guided tour to Everest Base Camp with accommodation',
    type: 'tour',
    category: 'Tourism',
    ...
    tourService: {
      ...
      itinerary: [
        { day: 1, location: 'Kathmandu', activities: ['Arrival', 'Preparation'] },
        { day: 2, location: 'Lukla', activities: ['Flight to Lukla', 'Trek to Phakding'] }
