...
async function testAdminAccess() {
  ...
  try {
    ...
    console.log(`✅ API Health: ${healthData.status} - ${healthData.message}\n`);
    ...
    if (loginData.success) {
      ...
      if (dashboardData.success) {
        ...
        console.log(`   Total Revenue: NPR ${dashboardData.data.totalRevenue.toLocaleString()}\n`);
        ...
        console.log(`✅ Services API working! Found ${servicesData.services.length} services`);
