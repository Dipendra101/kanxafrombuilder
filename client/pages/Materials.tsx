...
export default function Materials() {
  ...
  const materials = [
    ...
    },
    {
      ...
      specifications: { size: "400x200x200mm", type: "Hollow", strength: "M7.5" },
      rating: 4.5,
      reviews: 67
    },
    {
      ...
      stockQuantity: 5000,
      brand: "Local Kiln",
      specifications: { size: "230x110x70mm", type: "First Class", absorption: "<20%" },
      rating: 4.3,
      reviews: 234
    },
    {
      ...
      stockQuantity: 200,
      brand: "Kisan Pipes",
      specifications: { diameter: "4 inch", pressure: "6 kg/cm²", length: "6m" },
      rating: 4.7,
      reviews: 91
    },
    {
      ...
      stockQuantity: 25,
      brand: "Sintex",
      specifications: { capacity: "1000L", material: "LLDPE", layers: "3 Layer" },
      rating: 4.8,
      reviews: 45
    },
    {
      ...
      specifications: { type: "River Sand", fineness: "Fine", purity: "Washed" },
      rating: 4.4,
      reviews: 78
    },
    {
      ...
      stockQuantity: 150,
      brand: "Local Quarry",
      specifications: { size: "20mm", type: "Crushed", gradation: "Well graded" },
      rating: 4.5,
      reviews: 92
    },
    {
      ...
      specifications: { thickness: "0.47mm", coating: "Z275", profile: "Corrugated" },
      rating: 4.6,
      reviews: 134
    },
    {
      ...
      stockQuantity: 1000,
      brand: "Finolex",
      specifications: { size: "2.5 sq mm", conductor: "Copper", insulation: "PVC" },
      rating: 4.7,
      reviews: 167
    }
  ];
  ...
  const CartDialog = () => (
    <DialogContent className="max-w-2xl">
      <DialogHeader>
        <DialogTitle className="text-2xl font-bold text-kanxa-navy">Shopping Cart</DialogTitle>
      </DialogHeader>
          ...
          <>
            <div className="space-y-4 max-h-96 overflow-y-auto">
              {Object.entries(cart).map(([materialId, quantity]) => {
                ...
                return (
                  <div key={materialId} className="flex items-center gap-4 p-4 border rounded-lg">
                    <div className="text-3xl">{material.image}</div>
                    <div className="flex-1">
                      <h4 className="font-medium text-kanxa-navy">{material.name}</h4>
                    ...
                    <div className="flex items-center gap-2">
                      <Button size="sm" variant="outline" onClick={() => removeFromCart(materialId)}>
                        <Minus className="h-4 w-4" />
                      </Button>
                      <span className="w-12 text-center">{quantity}</span>
                      <Button size="sm" variant="outline" onClick={() => addToCart(materialId)}>
            ...
            <div className="space-y-4">
              <div className="flex justify-between text-lg font-bold">
                <span>Total:</span>
                <span className="text-kanxa-blue">NPR {getTotalPrice().toLocaleString()}</span>
              </div>
              
              <Alert>
                <Truck className="h-4 w-4" />
                <AlertDescription>
                  Free delivery for orders above NPR 50,000. Delivery charges apply for smaller orders.
                </AlertDescription>
              </Alert>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-white/90 mb-8">
              Quality building materials at competitive prices with reliable delivery across Nepal
            </p>
              ...
              <Card key={material.id} className="hover:shadow-lg transition-all duration-300 group">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-gray-500">({material.reviews} reviews)</span>
                  </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-end justify-between">
                      ...
                      <div className="text-right">
                        ...
                        <p className="text-sm font-medium">{material.stockQuantity}</p>
                      </div>
                    </div>
