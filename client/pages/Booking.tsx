...
export default function Booking() {
  ...
  const getServiceIcon = (type: string) => {
    switch (type) {
      case "bus": return <Bus className="h-5 w-5 text-kanxa-blue" />;
      case "cargo": return <Truck className="h-5 w-5 text-kanxa-orange" />;
      case "machinery": return <Settings className="h-5 w-5 text-kanxa-orange" />;
      case "garage": return <Settings className="h-5 w-5 text-kanxa-green" />;
      case "tour": return <MapPin className="h-5 w-5 text-kanxa-green" />;
      ...
      <div className="space-y-6">
        ...
        {booking.type === "cargo" && (
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <Label className="text-sm font-medium text-gray-600">Truck Type</Label>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="font-semibold">NPR {booking.dailyRate?.toLocaleString()}</p>
              </div>
            </div>
          </div>
        )}
        ...
        {booking.type === "garage" && (
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <Label className="text-sm font-medium text-gray-600">Appointment</Label>
                <p className="font-semibold">{booking.appointmentDate} at {booking.appointmentTime}</p>
              </div>
              <div>
        ...
        {booking.type === "tour" && (
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <Label className="text-sm font-medium text-gray-600">Tour Duration</Label>
                <p className="font-semibold">{booking.startDate} to {booking.endDate}</p>
              </div>
              <div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <p className="font-semibold">{booking.customer || booking.passenger}</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="font-semibold text-kanxa-green">NPR {(booking.amount || booking.totalAmount || booking.estimatedCost)?.toLocaleString()}</p>
          </div>
        </div>
  ...
  return (
    <Layout>
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-white/90 mb-8">
              Manage all your transportation, construction, and service bookings in one place
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
            <Card className="text-center">
              <CardContent className="p-6">
                <div className="text-3xl font-bold text-kanxa-blue mb-2">{bookings.length}</div>
            ...
            <Card className="text-center">
              <CardContent className="p-6">
                <div className="text-3xl font-bold text-kanxa-blue mb-2">
                  {bookings.filter(b => b.status === "active" || b.status === "scheduled").length}
                </div>
            ...
            <Card className="text-center">
              <CardContent className="p-6">
                <div className="text-3xl font-bold text-kanxa-navy mb-2">
                  NPR {bookings.reduce((sum, b) => sum + (b.amount || b.totalAmount || b.estimatedCost || 0), 0).toLocaleString()}
                </div>
      ...
      <section className="py-12">
        <div className="container">
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between mb-8">
            <h2 className="text-2xl font-bold text-kanxa-navy">Your Bookings</h2>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      {getServiceIcon(booking.type)}
                      <div>
                        <h3 className="font-bold text-kanxa-navy">{booking.service}</h3>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="text-right">
                        <p className="font-bold text-kanxa-green">
                          NPR {(booking.amount || booking.totalAmount || booking.estimatedCost)?.toLocaleString()}
                        </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      {booking.type === "bus" && (
                        <p className="font-semibold">{booking.route} • {booking.date}</p>
                      )}
                      {booking.type === "cargo" && (
                        <p className="font-semibold">{booking.route} • {booking.weight}</p>
                      )}
                      {booking.type === "machinery" && (
                        <p className="font-semibold">{booking.equipment}</p>
                      )}
                      {booking.type === "garage" && (
                        <p className="font-semibold">{booking.vehicleType} • {booking.serviceType}</p>
                      )}
                      {booking.type === "tour" && (
                        <p className="font-semibold">{booking.destination} • {booking.groupSize}</p>
                      )}
                    </div>
          ...
          {filteredBookings.length === 0 && (
            <div className="text-center py-12">
              ...
              <p className="text-gray-500 mb-4">You don't have any bookings for the selected filter</p>
              <Button variant="outline">
                Browse Services
              </Button>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container">
          <h2 className="text-2xl font-bold text-kanxa-navy text-center mb-8">Quick Actions</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <Card className="text-center hover:shadow-lg transition-shadow cursor-pointer">
              <CardContent className="p-6">
                <Bus className="h-12 w-12 text-kanxa-blue mx-auto mb-4" />
                <h3 className="font-semibold text-kanxa-navy mb-2">Book Bus Ticket</h3>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow cursor-pointer">
              <CardContent className="p-6">
                ...
                <h3 className="font-semibold text-kanxa-navy mb-2">Request Cargo</h3>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow cursor-pointer">
              <CardContent className="p-6">
                ...
                <h3 className="font-semibold text-kanxa-navy mb-2">Rent Machinery</h3>
            ...
            <Card className="text-center hover:shadow-lg transition-shadow cursor-pointer">
              <CardContent className="p-6">
                ...
                <h3 className="font-semibold text-kanxa-navy mb-2">Plan Tour</h3>
