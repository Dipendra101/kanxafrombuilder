        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-white/90 mb-8">
              We're here to help you with all your questions and concerns. Find
              answers, contact support, or browse our knowledge base.
            </p>
            ...
            {contactMethods.map((method, index) => (
              ...
              >
                <CardContent className="p-6">
                  ...
                  <p className="font-medium text-kanxa-blue mb-1">
                    {method.info}
                  </p>
                  ...
                  {[
                    {
                      ...
                      description:
                        "Step-by-step guide to booking your bus journey",
                    ...
                    },
                    {
                      ...
                      description:
                        "Complete guide to cargo transportation services",
                    ...
                    },
                    {
                      ...
                      description:
                        "All available payment options and procedures",
                      icon: <BookOpen className="h-6 w-6 text-kanxa-blue" />,
                      steps: [
        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-red-700 mb-6">
              For immediate assistance with breakdowns, accidents, or urgent
              issues:
            </p>
